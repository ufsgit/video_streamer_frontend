...
// API MENTION: Home screen displays user dashboard, active video progress, and completed courses.
// API endpoint for fetching dashboard data is not ready yet. Integrate backend APIs when available.
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Video Thumbnail Container (No image used per prompt rules for home screen)
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                // API MENTION: Video stream playback player API integration.
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Video playback API integration pending.'),
                                  ),
                                );
                              },
